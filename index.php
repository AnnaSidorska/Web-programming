...
<header class="header">
  <div class="container">
    ...
    <div class="header__inner">
      ...
      <nav class="nav">
        <a class="nav__link active" href="index.php">Головна</a>
    ...
    <div class="trainer__table">
      <div class="trainer__item">
        ...
        <div class="trainer__phone">
          <img class="trainer__icon" src=./images/phone.png alt="" style="width: 24px">
          <p>093 93 93 933</p>
        </div>
    ...
    <div class="block5__table">
      ...
      <div class="table__item table__center">
        <div class="block__suptitle"> 
          <img src="./images/star.png" alt="" style="width: 30px; height:30px">
          ЕСКЛЮЗИВ 
        </div>
  ...
  <div class="container">
    <div class="footer__items">
      ...
      <nav class="footer__navigation">
        <a class="footer__link active" href="index.php">Головна</a>
